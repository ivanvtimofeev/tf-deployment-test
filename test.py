...
class BaseTestCase(testtools.TestCase):
    ...
    def run_bash_test_on_host(self, bash_file_name, bash_local_test_dir = "/bash_tests", bash_remote_test_dir="/temp/tf-deployment-test"):
